...
@router.post('/shop/registration', tags=["Shop"])
...
@router.put("/shop/verify-email", tags=["Shop"])
...
@router.post("/shop/forgat-password", tags=["Shop"])
...
@router.put("/shop/reset-password", tags=["Shop"])
...
@router.post("/shop/verify-otp", tags=["Shop"])
